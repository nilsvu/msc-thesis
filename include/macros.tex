...
% Colors
\definecolor{coeffcolor}{RGB}{0, 50, 160}
\definecolor{Ecolor}{RGB}{160, 50, 0}
\definecolor{Mcolor}{RGB}{153, 153, 153}
...
\begin{itemize}
	\item \href{https://github.com/knly/msc-thesis/blob/master/nb/#1}{/nb/{#1} on GitHub}
\end{itemize}
\endgroup} 
\makeatother
...
\newcommand{\metdof}{{\varphi_\met}}
\newcommand{\armetdof}{{\varphi_\armet}}
\newcommand{\cosmodof}[2][]{{{y_{#1}}_{#2}}}
\newcommand{\Func}[2]{{F^{#1}_{#2}}}
\newcommand{\intertw}[2]{{I^{#1}}_{#2}}
\newcommand{\invintertw}[2]{{I_{#1}}^{#2}}
\newcommand{\canmom}{K}
\newcommand{\canmommet}{{\canmom_\met}}
\newcommand{\canmomarmet}{{\canmom_\armet}}
\newcommand{\Coeff}{C}
\newcommand{\pcoeff}{p}
