...
\begin{align}\label{eq:armet_symmetries}
	...
	\eqpunct{.}
\end{align}
Formulating the matter theory also requires us to specify a measure of spacetime volume~$\volel$. In metric geometry this is uniquely~$\volel_\met=\sqrtmet$\todo{show this}, but an area-metric geometry allows for some freedom in measuring volumes\todo{details?}. To facilitate a straight forward formulation of volume elements we implemented the boundary term in the formulation~\eqref{eq:maxwell_action_mod} of standard Maxwell electrodynamics to extract the volume measure as
...
\statement{We assume that our Universe is spatially isotropic and homogeneous.}
...
\begin{equation}
	\begin{metcases}
		...
		\Mcoeff{A}{\mu}=0
	\end{metcases}% \quad \text{and} \quad \begin{cases}
